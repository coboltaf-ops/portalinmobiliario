...
export default function MainLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { name: 'Usuarios', href: '/usuarios', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z' },
    { name: 'Roles', href: '/roles', icon: 'M12 6V4m6 2a2 2 0 100-4 2 2 0 000 4zM6 8a2 2 0 100-4 2 2 0 000 4zm0 0H4a2 2 0 00-2 2v4a2 2 0 002 2h2m12-6h2a2 2 0 012 2v4a2 2 0 01-2 2h-2m-6-10h2a2 2 0 012 2v4a2 2 0 01-2 2h-2' },
    { name: 'Módulos', href: '/modulos', icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z' },
