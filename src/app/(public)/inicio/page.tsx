...
export default function InicioPage() {
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between px-6 py-4 md:px-8" style={{ background: '#001e4d' }}>
        ...
        <div className="text-right">
          <p className="text-lg font-bold" style={{ color: '#ffffff', margin: 0 }}>Bienvenido</p>
          <p className="text-sm" style={{ color: '#ffffff', margin: 0 }}>al Portal</p>
        </div>
      </div>
